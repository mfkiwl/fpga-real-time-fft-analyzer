...
# Tighten only the critical setup path

# set_max_delay $my_budget #               -from [get_cells U_IIRFilter_2/u_filter_iir_cust4/mult_a0_1] #               -to   [get_cells U_IIRFilter_2/u_filter_iir_cust6/mult_b2_1]

# set_max_delay $my_budget #               -from [get_pins U_IIRFilter_2/u_filter_iir_cust2/mult_b0_1/CLK] #               -to   [get_pins U_IIRFilter_2/u_filter_iir_cust2/mult_a1_1/A[16]]
...
#set_property PACKAGE_PIN U9 [get_ports switch_1]
#set_property IOSTANDARD LVCMOS33 [get_ports switch_1]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
#set_property PACKAGE_PIN U8 [get_ports switch_2]
#set_property IOSTANDARD LVCMOS33 [get_ports switch_2]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
#set_property PACKAGE_PIN R7 [get_ports switch_3]
#set_property IOSTANDARD LVCMOS33 [get_ports switch_3]
##Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
#set_property PACKAGE_PIN R6 [get_ports switch_4]
...
set_property PACKAGE_PIN T8 [get_ports {led_s[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {led_s[0]}]
##Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
set_property PACKAGE_PIN V9 [get_ports {led_s[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {led_s[1]}]
...
set_property PACKAGE_PIN V4 [get_ports {led[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {led[5]}]
##Bank = 34, Pin name = IO_L8N_T1_34,						Sch name = LED9
set_property PACKAGE_PIN U3 [get_ports {led[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {led[6]}]
##Bank = 34, Pin name = IO_L7N_T1_34,						Sch name = LED10
set_property PACKAGE_PIN V1 [get_ports {led[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {led[7]}]
##Bank = 34, Pin name = IO_L17P_T2_34,						Sch name = LED11
set_property PACKAGE_PIN R1 [get_ports {led[8]}]
set_property IOSTANDARD LVCMOS33 [get_ports {led[8]}]
##Bank = 34, Pin name = IO_L13N_T2_MRCC_34,					Sch name = LED12
set_property PACKAGE_PIN P5 [get_ports {led[9]}]
set_property IOSTANDARD LVCMOS33 [get_ports {led[9]}]
##Bank = 34, Pin name = IO_L7P_T1_34,						Sch name = LED13
set_property PACKAGE_PIN U1 [get_ports {led[10]}]
set_property IOSTANDARD LVCMOS33 [get_ports {led[10]}]
##Bank = 34, Pin name = IO_L15N_T2_DQS_34,					Sch name = LED14
set_property PACKAGE_PIN R2 [get_ports {led[11]}]
set_property IOSTANDARD LVCMOS33 [get_ports {led[11]}]
##Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LED15
set_property PACKAGE_PIN P2 [get_ports {led[12]}]
...
set_property PACKAGE_PIN A9 [get_ports phy_mdio]
...
set_property PACKAGE_PIN D9 [get_ports phy_crs_dv]
set_property IOSTANDARD LVCMOS33 [get_ports phy_crs_dv]
